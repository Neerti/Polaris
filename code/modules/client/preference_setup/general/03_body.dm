...
/datum/category_item/player_setup_item/general/body/proc/SetSpecies(mob/user)
	...
	if("preview" in icon_states(current_species.icobase))
		usr << browse_rsc(icon(current_species.icobase,"preview"), "species_preview_[current_species.name_id].png")
		dat += "<img src='species_preview_[current_species.name_id].png' width='64px' height='64px'><br/><br/>"
