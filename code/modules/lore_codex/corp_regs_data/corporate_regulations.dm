...
/datum/lore/codex/category/corporate_minor_violations
	...
	//	/datum/lore/codex/page/law/misconduct,
...
/datum/lore/codex/page/law/misconduct
	name = "Misconduct"
	definition = "To behave an a way unbecoming of a crew member of NanoTrasen."
	suggested_punishments = "Fine of up to 100 thaler. Demotion at discretion of Superior."
	data = "This includes joking about a grave situation, not taking their job seriously, or otherwise a lack of professionalism."
*/
...
/* // Gonna move to SifLaw
/datum/lore/codex/page/law/excessive_force
	name = "Excessive Force"
	definition = "Using more force than what is required to safely detain someone, using force against a helpless or incapacitated person, or using force against an unarmed and compliant person."
	suggested_punishments = "Demotion.  Termination at discretion of Superior, or Station Admin.  Send notice to Central Command if a Head of Security had used excessive force."
	data = "Also sometimes called Infiltration.  Such areas include the AI upload/core, Armory, Engine, Atmospherics, Virology, Bridge, Station Admin's office."
*/
